...
def build_parser() -> argparse.ArgumentParser:
    ...
    c.add_argument("--workers", type=int, default=50, help="parallel workers")
    c.add_argument("--same-host", action="store_true", help="never leave seed hosts")
    c.add_argument("--delay", type=float, default=0.3, help="crawl-delay default")
    ...
    lp.add_argument("--workers", type=int, default=50, help="parallel workers")
    lp.add_argument("--same-host", action="store_true", help="never leave seed hosts")
    lp.add_argument("--delay", type=float, default=0.3, help="crawl-delay default")
    lp.add_argument("--timeout", type=float, default=12.0, help="request timeout")
